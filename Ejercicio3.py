...
num_payasos=int(input("Digite la cantidad de payasos: "))
num_munecas=int(input("Digite la cantidad de muñecas: "))

print("El peso total de payasos es: ",num_payasos*112)
print("El peso total de muñecas es: ",num_munecas*75)